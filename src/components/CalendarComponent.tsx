                    ...
                    {test &&
                        <>
                            ...
                            <Grid item xs={3}>
                                ...
                                <Grid item xs={12}>You can simulate todays date with the calendar component just above. On the left hand side is a representation of an advent calendar, and has some closed, ready to be open and opened pictures. A white rectange is a day in the future: you can't interact with it. A blue rectangle is a day in the past, or today: they are ready to be opened. You can interact wiht it by clicking on it: it will open the corresponding picture. You can reset the opened pictures, by clicking on the rest pictures button, on the top left hand side.</Grid>
                            </Grid>
                        </>
                    }
                </Grid>}
